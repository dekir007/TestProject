...
> [!NOTE]
> Немного оффтоп, размышления, оправдания. Получилось неидеально, но это мой первый опыт:) Не стал полировать до недостижимого идеала. Инструмент должен выполнять свою задачу и с некоторым задатком на масштабируемость. Считаю, что сделал достаточно.
